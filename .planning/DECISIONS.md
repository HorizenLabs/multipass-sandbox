...
**SHA256 verification**: Chained builds use `file:<parent>.sha256` sidecar files (already generated by `build.sh` in `sha256sum` format) for Packer's checksum verification.
